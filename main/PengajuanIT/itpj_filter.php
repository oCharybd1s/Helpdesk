<?php
  ...
  echo "<script> console.log('HELPDESK : itpj_filter') </script>";
  $getPengajuanIT = getDataPengajuan($_SESSION['tanggalFilter'],$_SESSION['bulanFilter'],$_SESSION['tahunFilter'],$_SESSION['cabangFilter'],'itpj');
?>
<table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="overflow-x:auto;">
  ...
  <tbody>
    ...
    ?>
          ...
          <td><?php echo $getPengajuanIT[$i]['printed']." Kali"; ?></td>
        </tr>
      <?php
        }
      ?>
