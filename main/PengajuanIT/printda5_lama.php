...
$isiheader = array(
		...
		array("label"=>"APLIKASI INVESTASI DIATAS 5.000.000", "length"=>80, "align"=>"C"),
...
#Isi Field
	...
	$pdf->SetTextColor(0);
	$pdf->SetDrawColor(0,0,0);	
	$pdf->Cell(180, 5,"ALASAN PEMBIAYAAN : ", 1, '0', 'L', false);
	$pdf->Ln();	
	...
	$pdf->SetTextColor(0);
	$pdf->SetDrawColor(0,0,0);	
	$pdf->Cell(180, 5,"RUANG ANALISIS : ", 1, '0', 'L', false);
	$pdf->Ln();	
