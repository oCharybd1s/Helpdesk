...
$ACCheader = array(
		array("labelACC"=>"DIBUAT", "length"=>45, "align"=>"C"),
		array("labelACC"=>"DIKETAHUI", "length"=>45, "align"=>"C"),
		array("labelACC"=>"DIPERIKSA", "length"=>45, "align"=>"C"),
		array("labelACC"=>"DISETUJUI", "length"=>45, "align"=>"C")
	);
$ACCisiheaderKOSONG = array(
		array("labelACC"=>"", "length"=>45, "align"=>"C"),
		array("labelACC"=>"", "length"=>45, "align"=>"C"),
		array("labelACC"=>"", "length"=>45, "align"=>"C"),		
		array("labelACC"=>"", "length"=>45, "align"=>"C")
	);
$ACCisiheader = array(
		array("labelACC"=>$namafull[0], "length"=>45, "align"=>"C"),
		array("labelACC"=>"KEPALA BAGIAN", "length"=>45, "align"=>"C"),
		array("labelACC"=>"PATA", "length"=>45, "align"=>"C"),
		array("labelACC"=>"DIREKTUR TERKAIT", "length"=>45, "align"=>"C")		
	);
...
$isiheader = array(
		array("label"=>"FM-IT-HW001", "length"=>50, "align"=>"C"),
		array("label"=>"PENGAJUAN BIAYA IT s/d 5.000.000", "length"=>80, "align"=>"C"),
		array("label"=>"01-Sep-2016", "length"=>50, "align"=>"C")
	);
