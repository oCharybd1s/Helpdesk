<?php
  ...
  echo "<script> console.log('HELPDESK : itpjberjalan_filter') </script>";
  $getPengajuanIT = getDataPengajuanBerjalan($_SESSION['tanggalFilter'],$_SESSION['bulanFilter'],$_SESSION['tahunFilter'],$_SESSION['cabangFilter'],'itpj');
?>
<table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="overflow-x:auto;">
  ...
  <tbody>
          ...
          ?>
                ...
                <td class="mycenter"><?php echo $getPengajuanIT[$i]['kurangacc'];?></td>
