<?php
	...
	$_SESSION['attchFilter'] = "All";
	echo "<script> console.log('HELPDESK : allpj') </script>";
?>
<!-- allpj -->
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2 id="title">Semua Pengajuan</h2>
      ...
      <div class="x_content">
        ...
        <div class='col-md-2 col-sm-12 col-xs-12'>
            Attachment
            <div class="form-group">
                <select id="attch" name="attch" class="form-control col-md-7 col-xs-12" onchange="filterHD()">
	    			<option value="All" selected>All</option>
