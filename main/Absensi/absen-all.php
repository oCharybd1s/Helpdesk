<?php
	...
	if (isset($_GET['id'])) $_SESSION['siapa']=$_GET['id']; else $_SESSION['siapa']='%';
	if (isset($_GET['bulan'])) $bulan=$_GET['bulan']; else $bulan='11';
	if (isset($_GET['tahun'])) $tahun=$_GET['tahun']; else $tahun='2024';

	$getAbsen = getDataAbsenP($_SESSION['siapa'],$bulan,$tahun);
?>
		<div class="row">
