...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2 id="title">Laporan Semua Pengajuan</h2>
      	...
      	<div class='col-md-12 col-sm-12 col-xs-12' id="contentTable">
		    ...
		    <div class='col-md-12 col-sm-12 col-xs-12'>
			    <div class='col-md-8 col-sm-8 col-xs-12'>
		          	<table id="datatable1" class="table table-striped table-bordered dt-responsive nowrap" style="overflow-x:auto;">
	                 	<thead>
	                        <tr>
	                          <th rowspan="2">CABANG</th>
	                          <th colspan="2">S/D 1 Juta</th>
	                          <th colspan="2">S/D 5 Juta</th>
	                          <th colspan="2">Diatas 5 Juta</th>
	                  ...
	                  <tbody>
	                  	<?php
							for($i=0; $i<count($getLaporanPengajuan); $i++){
						?>
			                    <tr>
			                      <td><?php echo $getLaporanPengajuan[$i]['cabang']?></td>
			                      <td><?php echo $getLaporanPengajuan[$i]['sd1']?></td>
			                      <td><?php echo number_format($getLaporanPengajuan[$i]['persensd1'],1)." %"; ?></td>
			                      <td><?php echo $getLaporanPengajuan[$i]['sd5']?></td>
			                      <td><?php echo number_format($getLaporanPengajuan[$i]['persensd5'],1)." %"; ?></td>
			                      <td><?php echo $getLaporanPengajuan[$i]['da5']?></td>
			                      <td><?php echo number_format($getLaporanPengajuan[$i]['persenda5'],1)." %"; ?></td>
			                      <td><?php echo $getLaporanPengajuan[$i]['JUMLAH']?></td>
			                    </tr>
		                <?php
		            		}
	            		?>
			                    <tr>
			                      <td><?php echo $getLaporanPengajuanTotal[0]['cabang']?></td>
			                      <td><?php echo $getLaporanPengajuanTotal[0]['sd1']?></td>
			                      <td><?php echo $getLaporanPengajuanTotal[0]['persensd1']." %"?></td>
			                      <td><?php echo $getLaporanPengajuanTotal[0]['sd5']?></td>
			                      <td><?php echo $getLaporanPengajuanTotal[0]['persensd5']." %"?></td>
			                      <td><?php echo $getLaporanPengajuanTotal[0]['da5']?></td>
			                      <td><?php echo $getLaporanPengajuanTotal[0]['persenda5']." %"?></td>
			                      <td><?php echo $getLaporanPengajuanTotal[0]['JUMLAH']?></td>
			                    </tr>
	                  </tbody>
	                </table>
		      	</div>
				<div class='col-md-4 col-sm-4 col-xs-12'>
					<div class='col-md-12 col-sm-12 col-xs-12'>
						<center><h2>Grafik Pengajuan</h2></center>
