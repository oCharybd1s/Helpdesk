      ...
      <div class="x_content">
        <div class="form-horizontal form-label-left" novalidate>
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
				  <input class="form-control col-md-7 col-xs-12" id="nopinjam" name="nopinjam" type="text" value="<?php echo $nomerpinjam[0]["nomer"]; ?>" disabled>
				</div>
			</div>
        	<div class="item form-group">
	            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tanggal">Tanggal Pinjam</label>
	            <div class="col-md-6 col-sm-6 col-xs-12">
	              <input id="tanggal" type="date" class="form-control" placeholder="Default Input">
	            </div>
          	</div>
          	<div class="item form-group">
	            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tanggalkembali">Tanggal Perkiraan Pengembalian</label>
	            <div class="col-md-3 col-sm-3 col-xs-12">
                <input id="duedate" type="date" class="form-control" placeholder="Default Input">
              </div> 
          	</div>
	        <div class="item form-group">
	            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="deskripsi">Catatan</label>
	            <div class="col-md-6 col-sm-6 col-xs-12">
	              <textarea id="catatan" name="deskripsi" class="form-control col-md-7 col-xs-12"></textarea>
	            </div>	        
      </div>
    </div>
    <div class="x_content">
            ...
            <tbody>
              <tr>
                ...
                <td class="col-sm-2" align="center">
                  <input type="text" name="prodno0" id="prodno0" class="form-control" style="width: 100%;" onchange="cariprodukpinjam(event,this.id,0);"/>
                </td>
                <td class="col-sm-2">
                  <input type="text" name="descript0" id="descript0" class="form-control" style="width: 100%;"/>
                </td>
                <td class="col-sm-1">
                  <input type="text" name="qty0" id="qty0" class="form-control" style="width: 100%;" onkeyup="checkstock(0)" />
                  <input type="hidden" name="qtyhd0" id="qtyhd0" class="form-control" style="width: 100%;" value="0" />
                </td>
              </tr>
            </tbody>
            <!-- <tfoot> -->
            ...
            <form class="form-horizontal form-label-left input_mask">
                <div class="form-group">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <button type="button" class="btn btn-success" onclick="submitpinjam('../action/newPinjam','new')">Simpan</button>
                  </div>
                </div>
            </form>
        </div>
