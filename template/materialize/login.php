  ...
  <body>
    ...
    <section class="body-sign">
      <div class="center-sign">
        <!-- <a href="template/porto//" class="logo float-left">
          <img src="template/podhub/assets/img/LOGO_CC2.png" height="54" alt="Porto Admin" />
        </a> -->
            ...
            <form method="post" id="form-login">
              <div class="form-group mb-3">
                ...
                <div class="input-group">
                  <input name="username" type="text" class="form-control form-control-lg" id="usr" />
              ...
              <div class="form-group mb-3">
                ...
                <div class="input-group">
                  <input name="password" type="password" class="form-control form-control-lg" id="psswd" />
                  <span class="input-group-append">
                    <span class="input-group-text">
    ...
    <script type="text/javascript">
      ...
      function login(){
        ...
        var data_login = {};
        var res = rutanApi('LoginGlobal', 'abUnn2e4evpP1vXmJGMa', {
          iddbase: "DB00000023",
          idapi: "API0000150",
        ...
        setTimeout(() => {
        if (res.length > 0) {
          res[0]['id'] = res[0].emp_no;
          var result = sendPost('setLoginSession', {
            login: res[0]
          });
          ...
          swalMessage('NIK/ID atau Password salah!');
          // $('#nik').val('');
          $('#password').val('');
        }
      }, 500);
...
<script type="text/javascript">
  ...
  if(islogin==1){
    var usr = '<?php echo json_encode($usr); ?>';
    var psswd = '<?php echo json_encode($psswd); ?>';
    let pjgusr = usr.length;
    let pjgpsswd = psswd.length;
    $('#usr').val(usr.slice(1, pjgusr-1));
    $('#psswd').val(psswd.slice(1, pjgpsswd-1));
    setTimeout(function() {
      login();
    }, 10);    
  }
