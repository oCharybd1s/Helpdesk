<div class="card">
	<div class="card-body">
        <div class="row">
            ...
            <div class="card">
                <h5 class="card-header" style="font-size:32px; color: #00a652;"><b>Tugas Saya</b></h5>
            ...
            <div class="card" style="margin-top: 20px;">
                <h5 class="card-header" style="font-size:32px; color: #00a652;"><b>Helpdesk Yang Belum Ditangani</b></h5>
            <div class="table-responsive text-nowrap">
                <table class="table" style="text-align: center;">
                <thead>
                    <tr>
                ...
                <tbody class="#table-body-issue" id="table-body-issue">
                ...
                <!-- Pagination controls -->
                <nav>
                    <ul class="pagination justify-content-center" id="tugasOpen" style="margin-top: 15px;">
                        <li class="page-item">
                            <a class="page-link" href="#" id="previous-page" aria-label="Previous">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
...
<script type="text/javascript">
            ...
            $.each(pageData1, function(index, row) {
                ...
                htmlbody += `
                        <tr>
                            ...
                            <td>
                                <span class="badge rounded-pill bg-label-warning">In Progress</span>
                        </td>
                    </tr>
                `; 
            });
    ...
    function printOpenIssue() {
        sendPost("Issue", {
            type_submit: "getOpenIssue",
            page: currentPageOpenIssue
        }, function(response) {
            ...
            priOpenIssue = response;
            openCount = priOpenIssue.total_count;
            let htmlbody = "";
            let dataArray = Array.isArray(priOpenIssue.data) ? priOpenIssue.data : [];
            let startIndex = 0;
            let endIndex = 20;
            ...
            pageData2 = dataArray.slice(startIndex, endIndex);
            if (pageData2.length === 0) {
                htmlbody = "<tr><td colspan='8' class='text-center'>No data available.</td></tr>"; 
            } else {
                $.each(pageData2, function(index, row) {
                    let formattedDate = formatDate(row.Tanggal.date);
                    let jenis = row.Jenis;
                    let matchedLap = all.find(item => item.Lap === jenis.toString());
                    let lapValue = matchedLap ? matchedLap.NamaLaporan : '-';
                    ...
                    htmlbody += `        
                        <tr>
                            ...
                            <td>
                                <span class="badge rounded-pill bg-label-success">Open</span>
                            </td>
                        </tr>`; 
                });
            }

            $('#table-body-issue').html(htmlbody);
